...
export default function StatusMessage({ isRecording }: Properties) {
    ...
    if (!isRecording) {
        return <p className="mb-4 mt-6 text-sm tracking-wide text-gray-200 md:text-sm md:text-2xl bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-500 bg-clip-text text-transparent drop-shadow-md">{t("status.notRecordingMessage")}</p>;
    }
